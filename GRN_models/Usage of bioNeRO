...
# eps = 0 means ARACNe only keeps edges where the correlation is unambiguously the strongest — it has no tolerance for close correlations, so it will remove many edges that are nearly as strong
